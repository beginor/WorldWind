...
namespace WorldWind {
	...
	public class ImageTileService {
		...
		private TimeSpan _cacheExpirationTime = TimeSpan.MaxValue;
		private string _datasetName;
		private string _serverUri;
		private string _serverLogoPath;
		#endregion
		...
		public ImageTileService(string datasetName, string serverUri, string serverLogoPath, TimeSpan cacheExpirationTime) {
		...
		/// <param name="serverUri"></param>
		/// <param name="serverLogoPath"></param>
		public ImageTileService(string datasetName, string serverUri, string serverLogoPath) {
			this._serverUri = serverUri;
			this._datasetName = datasetName;
			this._serverLogoPath = serverLogoPath;
		}
