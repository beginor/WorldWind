...
namespace WorldWind.Net.Monitor {
	...
	public class ProgressMonitor : Form {
		...
		private void InitializeComponent() {
			...
			// listView
			// 
			this.listView.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {this.columnHeader1, this.columnHeader2, this.columnHeader8, this.columnHeader5, this.columnHeader4, this.columnHeader6, this.columnHeader7, this.columnHeader3});
			...
			this.listView.Size = new System.Drawing.Size(768, 267);
			...
			// contextMenu
			// 
			this.contextMenu.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {this.menuItemHeaders, this.menuItemSpacer1, this.menuItemOpenUrl, this.menuItemViewDir, this.menuItemSpacer2, this.menuItemCopy, this.menuItemClear});
			...
			// mainMenu1
			// 
			this.mainMenu1.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {this.menuItemFile, this.menuItemEdit, this.menuItem9, this.menuItemTools});
			// 
			// menuItemFile
			// 
			this.menuItemFile.Index = 0;
			this.menuItemFile.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {this.menuItemFileRetry, this.menuItemSeparator3, this.menuItemFileClose});
			this.menuItemFile.Text = "&File";
			...
			this.menuItemEdit.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {this.menuItemEditCopy, this.menuItemEditDelete, this.menuItem6, this.menuItemEditSelectAll, this.menuItem7, this.menuItemEditClear});
			this.menuItemEdit.Text = "&Edit";
			...
			this.menuItem9.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {this.menuItemRun, this.menuItem4, this.menuItemWriteLog});
			this.menuItem9.Text = "&Monitor";
			// 
			// menuItemRun
			// 
			...
			this.menuItemTools.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {this.menuItemToolsDetails, this.menuItemSpacer3, this.menuItemToolsViewUrl, this.menuItemToolsViewDirectory});
			this.menuItemTools.Text = "&Tools";
			...
			this.ClientSize = new System.Drawing.Size(768, 267);
		...
		private void menuItemHeaders_Click(object sender, EventArgs e) {
			...
			HttpHeaderForm form = new HttpHeaderForm(item);
			form.Icon = this.Icon;
			form.Show();
		}
	...
	/// List view item
	/// </summary>
	internal class DebugItem : ListViewItem {
		...
		public void Update(WebDownload wd) {
			try {
				...
				if (m_headers == null && wd.response != null
				    && wd.response.Headers != null) {
					string hdr = "";
		...
		public override string ToString() {
			string proxy = WebRequest.DefaultWebProxy.GetProxy(new Uri(Url)).ToString();
			return string.Format(CultureInfo.CurrentCulture, "Start time: {7}{0}Total download time: {10}{0}Average transfer rate: {11:f1} kbit/s{0}Url: {1}{0}Target file: {2}{0}Progress: {3}/{4} bytes{0}Status: {5}{0}Proxy: {8}{0}{0}Response headers:{0}{9}{0}{6}{0}", Environment.NewLine, this.m_url, this.m_savedFilePath, this.m_bytesProcessed, this.ContentLength, this.m_status, this.Headers, this.m_startTime, proxy, "".PadRight(40, '='), this.m_elapsed, m_contentLength > 0 ? m_contentLength*8/m_elapsed.TotalSeconds/1000 : 0);
		}
	}
	...
	/// </summary>
	internal class DebugItemComparer : IComparer {
		private int column;
