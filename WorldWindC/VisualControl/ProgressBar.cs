...
namespace WorldWind.VisualControl {
	...
	public class ProgressBar {
		...
		private CustomVertex.TransformedColored[] progressBarBackground = new CustomVertex.TransformedColored[4];
		private CustomVertex.TransformedColored[] progressBarShadow = new CustomVertex.TransformedColored[4];
		private CustomVertex.TransformedColored[] progressBar = new CustomVertex.TransformedColored[4];
		private CustomVertex.TransformedColored[] progressRight = new CustomVertex.TransformedColored[4];
		private float x;
		private float y;
		private float width;
		...
		private static int backColor = Color.FromArgb(98, 200, 200, 200).ToArgb();
		private static int shadowColor = Color.FromArgb(98, 50, 50, 50).ToArgb();
		private static int outlineColor = 80 << 24;
